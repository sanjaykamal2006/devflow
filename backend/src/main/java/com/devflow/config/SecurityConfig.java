...
import com.devflow.security.JwtAuthenticationEntryPoint;
...
public class SecurityConfig {
    ...
    public SecurityConfig(
            ...
            @Value("${devflow.cors.allowed-origins:http://localhost:3000,http://localhost:3001}") String allowedOriginsStr) {
