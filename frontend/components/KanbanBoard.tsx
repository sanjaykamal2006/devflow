...
const COLUMNS: { id: IssueStatus; title: string; border: string }[] = [
  ...
  { id: 'IN_PROGRESS', title: 'In Progress', border: 'border-sky-900/60' },
  { id: 'IN_REVIEW', title: 'In Review', border: 'border-amber-900/60' },
  { id: 'DONE', title: 'Done', border: 'border-emerald-900/60' },
];
                ...
                colIssues.map((issue) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <Link
                        href={`/issues/${issue.id}`}
                        className="text-xs font-medium text-zinc-200 hover:text-white line-clamp-2 mb-2 block"
                      >
                        {issue.title}
                      </Link>
                      ...
                      {issue.labels && issue.labels.length > 0 && (
                        <div className="flex flex-wrap gap-1 mb-2">
                          {issue.labels.map((lbl) => (
                            <span
                              key={lbl.id}
                              className="text-[10px] px-1.5 py-0.2 rounded border border-zinc-800 bg-zinc-900 text-zinc-400"
